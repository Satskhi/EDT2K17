...
var user = API.getDJ().username;
	...
	const nsfw = ["PMCVHudpjgE","tf52mbGTB4o", "Rg6yj4f1KWA", "xVwb9Ws10Kc", "tMH3EqrOz2U", "9W8Q9FvH1XA", "O_QxG1rPW8Q", "wsUQKw4ByVg", "0W6HxYGth20", "Ei4rbJgMZPc"];
	...
	const fkthissong = ["291805417", "8QJV1sOm040", "KPeJaHTpsmc"];
	const nicesong = ["wmJ06K9v_Dc", "p-Z3YrHJ1sU", "Sks4r_Dwyic", "QqccaHauSKQ"];
	...
	else if (nicesong.indexOf(media) > -1) {
		API.sendChat("/me @"+user+" Nice Song! :heart_eyes_cat: :heart: ");
    }
